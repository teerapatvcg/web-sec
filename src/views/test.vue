      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <form class="form-inline ml-3">
          <div class="btn-group" role="group" aria-label="Basic example">
            <button type="button" class="btn btn-primary" @click="ci_home">Home</button>
            <button type="button" class="btn btn-success" @click="ci_contact">Contact</button>
            <button type="button" class="btn btn-danger" @click="ci_promotion">Promotion</button>
        ...
        <div class="sidebar">
          ...
          <nav class="mt-2">
              <form action="" >
                ...
                <br />
                <a href="#" class="btn btn-success" style="color: black">ค้นหา</a>
