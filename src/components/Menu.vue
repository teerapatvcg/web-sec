        ...
        <div class="row">
          ...
          <br>
            ...
            <button
              ...
              @click="ci_promotion"
            ><svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-alarm-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
